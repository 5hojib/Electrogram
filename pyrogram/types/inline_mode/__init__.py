...
from .inline_query_result_cached_audio import (
    InlineQueryResultCachedAudio,
)
from .inline_query_result_cached_document import (
    InlineQueryResultCachedDocument,
)
from .inline_query_result_cached_photo import (
    InlineQueryResultCachedPhoto,
)
from .inline_query_result_cached_sticker import (
    InlineQueryResultCachedSticker,
)
from .inline_query_result_cached_video import (
    InlineQueryResultCachedVideo,
)
from .inline_query_result_cached_voice import (
